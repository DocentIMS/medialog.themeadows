...
class ViewsIntegrationTest(unittest.TestCase):
    ...
    def test_aminity_view_is_registered(self):
        view = getMultiAdapter(
            (self.portal['other-folder'], self.portal.REQUEST),
            name='aminity-view'
        )
        self.assertTrue(view.__name__ == 'aminity-view')
        # self.assertTrue(
        #     'Sample View' in view(),
        #     'Sample View is not found in aminity-view'
        # )

    def test_aminity_view_not_matching_interface(self):
